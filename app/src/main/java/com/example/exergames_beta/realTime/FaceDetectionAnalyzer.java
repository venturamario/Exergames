                        ...
                        runOnUiThread(() -> {
                            ...
                            if (!faces.isEmpty()) {
                                ...
                                if (noseBase != null) {
                                    ...
                                    // Obtener el ancho del PreviewView
                                    int viewFinderWidth = viewFinder.getWidth();

                                    // Invertir la coordenada X
                                    float invertedX = viewFinderWidth - coordenadaActual.getX();

                                    // Actualizar coordenada con el nuevo valor invertido
                                    coordenadaActual.setX(invertedX);
